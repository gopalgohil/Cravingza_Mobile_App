            ...
            return (
              <View key={idx} style={styles.applicantRow}>
                ...
                <View style={[styles.typeBadgePill, isRest ? styles.typeRest : styles.typeRider]}>
                  {isRest ? (
                    <Svg width={12} height={12} viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4 }}>
                      <Path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
                      <Path d="M9 22V12h6v10" />
                    </Svg>
                  ) : (
                    <Svg width={12} height={12} viewBox="0 0 24 24" fill="none" stroke="#0284C7" strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4 }}>
                      <Circle cx="5.5" cy="17.5" r="2.5" />
                      <Circle cx="18.5" cy="17.5" r="2.5" />
                      <Path d="M15 6h5l3 5v6h-2M9 17h6M5 17H3v-5l2-4h8v9" />
                    </Svg>
